...
---- Global: Size clients
awful.keyboard.append_global_keybindings({
    awful.key({ mod.super, mod.alt }, 'Left', function() awful.tag.incmwfact(-0.05) end,
              {description = 'decrease width', group = 'client'}),
    awful.key({ mod.super, mod.alt }, 'Down', function() awful.client.incwfact(0.05) end,
              {description = 'decrease height', group = 'client'}),
    awful.key({ mod.super, mod.alt }, 'Up', function() awful.client.incwfact(-0.05) end,
              {description = 'increase height', group = 'client'}),
    awful.key({ mod.super, mod.alt }, 'Right', function() awful.tag.incmwfact(0.05) end,
...
client.connect_signal('request::default_keybindings', function()
    awful.keyboard.append_client_keybindings({
        ...
        -- Kill client (close)
        awful.key({ mod.super, mod.shift }, 'c',
            function(c)
                c:kill()
            end,
...
client.connect_signal('request::default_mousebindings', function()
    awful.mouse.append_client_mousebindings({
        ...
        awful.button({ mod.super, mod.ctrl }, 1, function (c)
            c:activate { context = 'mouse_click' }
...
--- My application 
awful.keyboard.append_global_keybindings({
    awful.key({ mod.super }, 'b', function() awful.spawn(apps.browser) end,
              {description = 'open a browser', group = 'apps'}),
    awful.key({ mod.super }, 'e', function() awful.spawn(apps.files) end,
    ...
    awful.key({ mod.super }, "p", function () awful.util.spawn_with_shell(apps.colorpicker) end,
              {description = "color-picker", group = "apps"}),
    awful.key({ mod.super }, "l", function () awful.util.spawn_with_shell(apps.lock) end,
